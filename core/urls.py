...
# Action Taken
    ...
    path('AdmnOfc_resign',views.AdmnOfc_resign, name='AdmnOfc_resign'),
    path('AdmnOfc_registration_update/<int:id>',views.AdmnOfc_registrationUpdate, name='AdmnOfc_registrationUpdate'),
    path('AdmnOfc_registration_update_save/<int:id>',views.AdmnOfc_registrationUpdateSave, name='AdmnOfc_registrationUpdateSave'),
    path('AdmnOfc_registrationDelete/<int:id>',views.AdmnOfc_registrationDelete, name='AdmnOfc_registrationDelete'),
    path('AdmnOfc_new_registration',views.AdmnOfc_newRegistration, name='AdmnOfc_newRegistration'),
    path('AdmnOfc_registration_status/<int:id>',views.AdmnOfc_registrationStatus, name='AdmnOfc_registrationStatus'),
    path('AdmnOfc_attendance',views.AdmnOfc_attendance, name='AdmnOfc_attendance'),
    path('AdmnOfc_work_status',views.AdmnOfc_workStatus, name='AdmnOfc_workStatus'),
    path('AdmnOfc_designations',views.AdmnOfc_designations, name='AdmnOfc_designations'),
    path('AdmnOfc_employees',views.AdmnOfc_employees, name='AdmnOfc_employees'),
    path('AdmnOfc_projects_details',views.AdmnOfc_projectsDetails, name='AdmnOfc_projectsDetails'),
    path('AdmnOfc_trainee_status',views.AdmnOfc_traineeStatus, name='AdmnOfc_traineeStatus'),
    path('AdmnOfc_trainees',views.AdmnOfc_trainees, name='AdmnOfc_trainees'),
    path('AdmnOfc_trainee_details',views.AdmnOfc_traineeDetails, name='AdmnOfc_traineeDetails'),
    path('AdmnOfc_leave_status',views.AdmnOfc_leaveStatus, name='AdmnOfc_leaveStatus'),
    path('AdmnOfc_other_leave_history',views.AdmnOfc_otherLeaveHistory, name='AdmnOfc_otherLeaveHistory'),
    path('AdmnOfc_leavedesgn',views.AdmnOfc_leavedesgn, name='AdmnOfc_leavedesgn'),
    path('AdmnOfc_leave_details',views.AdmnOfc_leaveDetails, name='AdmnOfc_leaveDetails'),
    path('AdmnOfc_request_exp_certificate/<int:id>',views.AdmnOfc_requestExpCertificate, name='AdmnOfc_requestExpCertificate'),
    path('BRadmin_exp_certificate_requests',views.BRadmin_ExpCertificateRequests, name='BRadmin_ExpCertificateRequests'),
    path('BRadmin_approve_exp_request/<int:id>',views.BRadmin_approveExpRequest, name='BRadmin_approveExpRequest'),
    path('BRadmin_reject_exp_request/<int:id>',views.BRadmin_rejectExpRequest, name='BRadmin_rejectExpRequest'),
    path('AdmnOfc_projects_list/<int:id>',views.AdmnOfc_projectsList, name='AdmnOfc_projectsList'),
    path('AdmnOfc_project_details/<int:id>',views.AdmnOfc_projectDetails, name='AdmnOfc_projectDetails'),
    path('AdmnOfc_projects_completed/<int:id>',views.AdmnOfc_projectsCompleted, name='AdmnOfc_projectsCompleted'),
    path('AdmnOfc_all_employees',views.AdmnOfc_allEmployees, name='AdmnOfc_allEmployees'),
    path('AdmnOfc_department_employees/<int:id>',views.AdmnOfc_departmentEmployees, name='AdmnOfc_departmentEmployees'),
    path('AdmnOfc_designation_employees/<int:id>/<int:did>',views.AdmnOfc_designationEmployees, name='AdmnOfc_designationEmployees'),
